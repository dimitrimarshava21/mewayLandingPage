            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button className="h-10 w-10 rounded-full border border-gray-200 flex items-center justify-center hover:bg-gray-100">
                        ...
                        <button className="flex items-center gap-5 rounded-full border border-gray-200 px-3 py-1 hover:bg-gray-100">
                            <Image width={16} height={16} alt="menu" src="/line.svg" />
                            <Image width={30} height={30} alt="profile" src="/profile.svg" />
                        </button>
                    </div>
                </div>
            </div>
