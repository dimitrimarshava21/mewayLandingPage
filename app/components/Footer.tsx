...
const footerLinks = [
  ...
  {
    title: "SEO სათაური",
    links: ["პოპულარული", "ბიზნესის ავტომატიზაცია", "ვებ", "პოპულარული"],
  },
];
...
const categories = [
  ...
  {
    title: "ქალაქები",
    links: ["თბილისი", "ბათუმი", "ქუთაისი", "რუსთავი", "თელავი", "სვანეთი"],
  },
];

const Footer = () => {
  return (
    <footer className="bg-footer bg-[#DDDDDD] py-20">
      <div className="container mx-auto px-6 py-12">
            ...
            <div key={idx}>
              <h3
                className={`relative font-semibold text-foreground mb-6 ${
                  idx === 0
                    ? "after:absolute after:left-0 after:-bottom-2 after:h-px after:w-370 after:bg-[#DDDDDDDD]"
                    : ""
                }`}
              >
                {column.title}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="flex h-full flex-col">
            {/* Contact info */}
            <div>
              <h3 className="font-semibold text-foreground mb-4">კონტაქტი</h3>
              <ul className="space-y-3">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[#DDDDDDDD] border-footer-border pt-6">
